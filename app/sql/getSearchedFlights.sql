...
WHERE (outboundLandingLocation = :goingTo OR :goingTo = 1) AND ((DAYNAME(flightDate) = :day OR :day = 1) AND (flightDate >= :dateFrom AND returnDate <= :dateTo)) AND returnID IS NOT NULL
